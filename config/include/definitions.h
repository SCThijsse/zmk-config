...
#define NAVIGA_L2 &kp C_PREV     &kp C_NEXT   &kp C_STOP   &kp C_PLAY   &kp C_VOL_UP
#define NAVIGA_L3 &kp LGUI       &kp LALT     &kp LCTRL    &kp LSHFT    &kp C_VOL_DN
#define NAVIGA_L4 &bootloader    &trans       &to 1        &to 2        &kp C_MUTE
...
#define FUNCTI_L2 &reset         &trans       &trans       &trans       &trans
#define FUNCTI_L3 &kp LGUI       &kp LALT     &kp LCTRL    &kp LSHFT    &trans
#define FUNCTI_L4 &bootloader    &kp RALT     &tog 3       &tog 3       &trans
...
#define NUMBER_R2 &bt BT_NXT     &bt BT_SEL 0 &bt BT_SEL 1 &bt BT_CLR   &reset
#define NUMBER_R3 &bt BT_PRV     &kp LSHFT    &kp LCTRL    &kp LALT     &kp LGUI
#define NUMBER_R4 &out OUT_USB   &out OUT_BLE &out OUT_TOG &kp RALT     &bootloader
...
#define SYMBOL_R2 &trans         &trans       &trans       &trans       &reset
#define SYMBOL_R3 &trans         &kp LSHFT    &kp LCTRL    &kp LALT     &kp LGUI
#define SYMBOL_R4 &trans         &trans       &trans       &kp RALT     &bootloader
